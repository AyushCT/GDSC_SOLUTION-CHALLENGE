...
<div class="container-fluid">
  ...
  <a class="active" href="receiver.php"><i class="fa fa-handshake"></i></a>
  <a href="logout.php" style="margin-top:300px;"><i class="fas fa-sign-out-alt"></i></a> 
        ...
        <!-- card ends -->
        <div class="container-fluid p-5" style="background-color:#008BDC; width:1200px;border-radius:30px;">
      <div class="container">
        
        <div class="row">
            <h2 class="text-center text-light">Plz Select the Asset you want to Recieve</h2>
